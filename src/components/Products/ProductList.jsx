    ...
    <>
      ...
      <div className={makeupstyles.sortContainer}>
        ...
        <select
          ...
          className={makeupstyles.sortBtn}
        >
            ...
            <div style={{ cursor: "pointer" }} key={item.productId}>
              <div className={ProductListStyle.badgeHolderParent}>
                <div className={ProductListStyle.badgeHolder}>
                  ...
                  {item.currentSku.isLimitedEdition ? (
                    <div>
                      <div className={ProductListStyle.badgeStyle}>
                        limited edition
                      </div>
                      <br />
                    </div>
              ...
              <h5 style={{ fontSize: "18px", fontWeight: "450" }}>
                {item.displayName}
              </h5>
              <p style={{ fontSize: "13px", fontWeight: "500", color: "grey" }}>
                {item.moreColors} colours
              </p>
              <div
